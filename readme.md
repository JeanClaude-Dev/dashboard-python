# 📊 Global Data Salary Insights Dashboard
...
- **Análise por Cargo:** Gráfico de barras interativo mostrando os cargos com maior remuneração.
- **Distribuição Estatística:** Histograma de frequências para identificar faixas salariais comuns.
- **Filtros Personalizados:** Interface limpa com CSS customizado para filtrar dados por ano, senioridade e modelo de contrato.
- **UI/UX Moderna:** Design focado em legibilidade com uso de sombras, paleta azul marinho e layout responsivo.
