...
if not df_filtrado.empty:
    ...
    with col_donut:
        ...
        fig_donut.update_layout(title_font_size=14, height=400, showlegend=True, legend=dict(yanchor="top", y=0.1, xanchor="left", x=0.1))
...
# --- Rodapé ---
with st.expander("🔍 Detalhes da Amostragem"):
